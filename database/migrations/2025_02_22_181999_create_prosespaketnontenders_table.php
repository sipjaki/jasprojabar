...
return new class extends Migration
{
    ...
    {
        Schema::create('prosespaketnontenders', function (Blueprint $table) {
            $table->id();
            $table->foreignId('profilpaketpekerjaannontender_id')->nullable();;
    ...
    {
        Schema::dropIfExists('prosespaketnontenders');
    }
};
