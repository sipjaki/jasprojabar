...
return new class extends Migration
{
    ...
    {
        Schema::create('krkkeagamaans', function (Blueprint $table) {
            $table->id();
            $table->foreignId('krkusahasurat_id')->nullable()->index(); // PEMOHON
            $table->foreignId('krkkeagamaancek_id')->nullable()->index(); // PEMOHON
            ...
            $table->string('suratupload')->nullable(); // UPLOAD BARU BERKAS
    ...
    {
        Schema::dropIfExists('krkkeagamaans');
    }
};
