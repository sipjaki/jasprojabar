...
return new class extends Migration
{
    ...
    {
        Schema::create('profilpaketpekerjaannontenders', function (Blueprint $table) {
            $table->id();
            $table->foreignId('prosespaketnontender_id')->nullable();
    ...
    {
        Schema::dropIfExists('profilpaketpekerjaannontenders');
    }
};
