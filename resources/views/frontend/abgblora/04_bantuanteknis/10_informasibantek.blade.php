...
<div style="max-width: 1200px; margin: 20px auto; padding: 10px; border: 1px solid #ddd; border-radius: 8px; box-shadow: 0 2px 6px rgba(0,0,0,0.1); background-color: #fff; text-align: center;">
    <img src="/assets/00_administrator/04_bantuanteknis/14.jpg" alt="Lampiran" style="width: 100%; height: auto; border-radius: 6px;" />
</div>

<div style="max-width: 1200px; margin: 20px auto; padding: 10px; border: 1px solid #ddd; border-radius: 8px; box-shadow: 0 2px 6px rgba(0,0,0,0.1); background-color: #fff; text-align: center;">
    <img src="/assets/00_administrator/04_bantuanteknis/15.jpg" alt="Lampiran" style="width: 100%; height: auto; border-radius: 6px;" />
</div>
