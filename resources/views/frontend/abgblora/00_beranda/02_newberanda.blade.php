...
<head>
  ...
  <link href="/assets/new/output.css" rel="stylesheet">
...
<body class="font-poppins text-[#030303] bg-[#F6F5FA] pb-[100px] px-4 sm:px-0">
  <nav class="container max-w-[1130px] mx-auto flex items-center flex-wrap justify-between p-4 rounded-[20px] bg-white mt-[30px] gap-y-3 sm:gap-y-0">
    <a href="index.html">
        <img src="/assets/new/logos/logo.svg" alt="logo">
    </a>
    ...
    <div class="flex items-center gap-3">
        ...
        <div class="w-[50px] h-[50px] rounded-full overflow-hidden flex shrink-0">
            <img src="/assets/new/photos/profile.png" class="w-full h-full object-cover" alt="photo">
        </div>
    </div>
  </nav>
    ...
    <div class="flex flex-col sm:flex-row justify-end items-center gap-3 w-full sm:w-auto">
        <div class="p-2 pl-5 rounded-full bg-white flex items-center justify-between gap-2 w-full sm:w-[500px] focus-within:ring-2 focus-within:ring-[#6635F1] transition-all duration-300">
            ...
            <button class="w-9 h-9 flex shrink-0">
                <img src="/assets/new/icons/search.svg" alt="icon">
            </button>
        </div>
  ...
  <section id="categories" class="container max-w-[1130px] mx-auto flex flex-col gap-4 mt-[50px]">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-5 gap-5">
        <a href="category-auth.html" class="card">
            <div class="p-5 rounded-[20px] bg-white flex flex-col gap-[30px] hover:ring-2 hover:ring-[#6635F1] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="/assets/new/icons/Digital Marketing 101.svg" alt="icon">
                </div>
        ...
        <a href="category-auth.html" class="card">
            <div class="p-5 rounded-[20px] bg-white flex flex-col gap-[30px] hover:ring-2 hover:ring-[#6635F1] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="/assets/new/icons/UIUX 2.svg" alt="icon">
                </div>
                <div class="flex flex-col gap-[6px]">
        ...
        <a href="category-auth.html" class="card">
            <div class="p-5 rounded-[20px] bg-white flex flex-col gap-[30px] hover:ring-2 hover:ring-[#6635F1] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="/assets/new/icons/Web Development.svg" alt="icon">
                </div>
                <div class="flex flex-col gap-[6px]">
        ...
        <a href="category-auth.html" class="card">
            <div class="p-5 rounded-[20px] bg-white flex flex-col gap-[30px] hover:ring-2 hover:ring-[#6635F1] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="/assets/new/icons/Basic Interview.svg" alt="icon">
                </div>
                <div class="flex flex-col gap-[6px]">
        ...
        <a href="category-auth.html" class="card">
            <div class="p-5 rounded-[20px] bg-white flex flex-col gap-[30px] hover:ring-2 hover:ring-[#6635F1] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="/assets/new/icons/UIUX 1.svg" alt="icon">
                </div>
                <div class="flex flex-col gap-[6px]">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-4 gap-5">
        <a href="details.html" class="card">
            <div class="p-5 rounded-[20px] bg-white flex flex-col gap-5 hover:ring-2 hover:ring-[#6635F1] transition-all duration-300">
                <div class="w-full h-[140px] rounded-[20px] overflow-hidden relative">
                    ...
                    <img src="/assets/new/thumbnails/thumbnail-1.png" class="w-full h-full object-cover" alt="thumbnail">
                </div>
        ...
        <a href="details.html" class="card">
            <div class="p-5 rounded-[20px] bg-white flex flex-col gap-5 hover:ring-2 hover:ring-[#6635F1] transition-all duration-300">
                <div class="w-full h-[140px] rounded-[20px] overflow-hidden relative">
                    ...
                    <img src="/assets/new/thumbnails/thumbnail-2.png" class="w-full h-full object-cover" alt="thumbnail">
                </div>
                <div class="flex flex-col gap-[10px]">
        ...
        <a href="details.html" class="card">
            <div class="p-5 rounded-[20px] bg-white flex flex-col gap-5 hover:ring-2 hover:ring-[#6635F1] transition-all duration-300">
                <div class="w-full h-[140px] rounded-[20px] overflow-hidden relative">
                    <div class="font-bold text-xs leading-[18px] text-white bg-[#2E82FE] p-[2px_10px] rounded-full w-fit absolute top-[10px] left-[10px]">HIRING</div>
                    <img src="/assets/new/thumbnails/thumbnail-3.png" class="w-full h-full object-cover" alt="thumbnail">
                </div>
                <div class="flex flex-col gap-[10px]">
        ...
        <a href="details.html" class="card">
            <div class="p-5 rounded-[20px] bg-white flex flex-col gap-5 hover:ring-2 hover:ring-[#6635F1] transition-all duration-300">
                <div class="w-full h-[140px] rounded-[20px] overflow-hidden relative">
                    <div class="font-bold text-xs leading-[18px] text-white bg-[#2E82FE] p-[2px_10px] rounded-full w-fit absolute top-[10px] left-[10px]">HIRING</div>
                    <img src="/assets/new/thumbnails/thumbnail-4.png" class="w-full h-full object-cover" alt="thumbnail">
                </div>
                <div class="flex flex-col gap-[10px]">
        ...
        <div class="flex flex-col gap-5">
            <div class="card hover:ring-2 hover:ring-[#6635F1] transition-all duration-300 bg-white p-5 rounded-[20px] flex flex-col sm:flex-row sm:items-center gap-[18px] w-full">
                ...
                <div class="flex flex-col gap-[10px]">
                    ...
                    <p class="text-sm leading-7 line-clamp-2">I'm seeking a proficient developer to create a unique opinion collection app without a user registration feature would If you're passionate abou...</p>
            ...
            <div class="card hover:ring-2 hover:ring-[#6635F1] transition-all duration-300 bg-white p-5 rounded-[20px] flex flex-col sm:flex-row sm:items-center gap-[18px] w-full">
                ...
                <div class="flex flex-col gap-[10px]">
                    <div class="font-bold text-xs leading-[18px] text-white bg-[#2E82FE] p-[2px_10px] rounded-full w-fit">HIRING</div>
                    <a href="details.html" class="font-semibold text-lg leading-[27px]">Education Commerce Website Development</a>
                    <p class="text-sm leading-7 line-clamp-2">I'm seeking a proficient developer to create a unique opinion collection app without a user registration feature would If you're passionate abou...</p>
                    <div class="flex flex-col sm:flex-row sm:items-center gap-3">
                        <div class="flex items-center gap-[6px]">
                            <div>
        ...
        <div class="flex flex-col gap-[10px] rounded-[20px] p-[10px_14px] bg-[#030303]">
            <div class="flex items-center gap-3">
                <div class="w-8 h-8 flex shrink-0">
                    <img src="/assets/new/icons/story.svg" alt="">
                </div>
        ...
        <div class="flex flex-col gap-3">
            ...
            <div class="flex flex-col gap-[18px]">
                <a href="" class="resources-card">
                    <div class="group flex gap-3 items-center">
                        <div class="w-[50px] h-[50px] flex shrink-0">
                            <img src="/assets/new/icons/perosnalcard.svg" alt="icon">
                        </div>
                ...
                <a href="" class="resources-card">
                    <div class="group flex gap-3 items-center">
                        <div class="w-[50px] h-[50px] flex shrink-0">
                            <img src="/assets/new/icons/note-add.svg" alt="icon">
                        </div>
                        <div class="flex flex-col justify-center gap-[2px]">
                ...
                <a href="" class="resources-card">
                    <div class="group flex gap-3 items-center">
                        <div class="w-[50px] h-[50px] flex shrink-0">
                            <img src="/assets/new/icons/code.svg" alt="icon">
                        </div>
                        <div class="flex flex-col justify-center gap-[2px]">
                ...
                <a href="" class="resources-card">
                    <div class="group flex gap-3 items-center">
                        <div class="w-[50px] h-[50px] flex shrink-0">
                            <img src="/assets/new/icons/user-octagon.svg" alt="icon">
                        </div>
                        <div class="flex flex-col justify-center gap-[2px]">
