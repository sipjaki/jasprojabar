        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <img src="/assets/icon/pupr.png" alt="Technoit" class="img-fluid" style="margin-right:5px; width:5%;">
              <img src="/assets/icon/logokabupatenblora.png" alt="Technoit" class="img-fluid" style="width:5%; margin-right:7px;">
