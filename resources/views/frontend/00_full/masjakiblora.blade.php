    ...
    <nav class="navbar navbar-expand-lg">
      <div class="container">
        <a class="navbar-brand" href="index.html">
          <img src="/assets/icon/pupr.png" alt="PUPR" class="img-fluid" style="width: 20%">
          <img src="/assets/icon/logokabupatenblora.png" alt="KabBlora" class="img-fluid" style="width: 20%">
        </a>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="packages.html">Renstra Kab Blora</a></li>
                  <li><a class="dropdown-item" href="faqs.html">Tupoksi Jasa Konstruksi</a></li>
