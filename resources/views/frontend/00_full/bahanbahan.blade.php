    ...
    <nav class="navbar navbar-expand-lg">
      <div class="container">
        <a class="navbar-brand" href="index.html">
          <img src="/assets/icon/pupr.png" alt="Technoit" class="img-fluid" style="margin-right:5px; width:65%;">
          <img src="/assets/icon/logokabupatenblora.png" alt="Technoit" class="img-fluid" style="width:65%; margin-right:7px;">
        </a>
        ...
        {{-- <a class="navbar-brand" href="index.html">
            <img src="/assets/icon/pupr.png" 
                 alt="Technoit" 
                 class="img-fluid" 
                 style="margin-right: 5px; width: 70%; max-width: 100%; height: auto; 
