<footer id="footer" class="footer-section" style="background: url(/assets/masjakiblora/images/hero-bg.jpg) center left;">
    <div class="container">
        ...
        <div class="row">
          <div class="col-xl-6 col-lg-6 text-left text-lg-left">
            <div class="copyright-text">
              <p>&copy; 2025 Dinas Pekerjaan Umum dan Penataan Ruang <br>Pemerintah Kabupaten Blora Provinsi Jawa Tengah
              </p>
            </div>
          </div>
        </div>
