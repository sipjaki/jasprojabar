...
{{--
                        ...
                        <body>
                            <div class="table-wrapper" style="margin-top:-130px; position: relative;">
                                ...
                                <table class="fl-table" id="sortableTable" style="margin-top: 15px; width: 100%; border-collapse: collapse;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th onclick="sortTable(1)" style="cursor:pointer; text-align:center; width:250px;"> Uraian <span class="sort-icon">⇅</span></th>
                                            <th onclick="sortTable(2)" style="cursor:pointer; text-align:center; width:75px;"> Kode <span class="sort-icon">⇅</span></th>
                                            <th onclick="sortTable(3)" style="cursor:pointer; text-align:center; width:100px;"> Satuan <span class="sort-icon">⇅</span></th>
                                            <th onclick="sortTable(4)" style="cursor:pointer; text-align:center; width:75px;"> Rp. <span class="sort-icon">⇅</span></th>
                                            <th onclick="sortTable(5)" style="cursor:pointer; text-align:center; width:100px;"> Besaran <span class="sort-icon">⇅</span></th>
                                            {{-- <th onclick="sortTable(6)" style="cursor:pointer; text-align:center; width:75px;"> Rp. <span class="sort-icon">⇅</span></th>
                                            <th onclick="sortTable(7)" style="cursor:pointer; text-align:center; width:100px;"> Besaran Per Jam <span class="sort-icon">⇅</span></th> --}}
                                            {{-- <th onclick="sortTable(6)" style="cursor:pointer; text-align:center; width:200px;"> Keterangan <span class="sort-icon">⇅</span></th> --}}
                                ...
                                <br>
                                <p style="color: black;">Keterangan : AHSP Kabupaten Blora Tahun 2025</p>
