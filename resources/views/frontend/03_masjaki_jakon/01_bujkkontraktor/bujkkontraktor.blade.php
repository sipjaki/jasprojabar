                                ...
                                <table class="fl-table" id="sortableTable" style="margin-top: 15px; width: 100%; border-collapse: collapse;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th onclick="sortTable(0)" style="cursor:pointer; text-align:center; width:100px;"> Nama Lengkap <span class="sort-icon">⇅</span></th>
                                            <th onclick="sortTable(0)" style="cursor:pointer; text-align:center; width:100px;"> Alamat <span class="sort-icon">⇅</span></th>
                                            <th onclick="sortTable(0)" style="cursor:pointer; text-align:center; width:100px;"> Jabatan Kerja <span class="sort-icon">⇅</span></th>
                                            <th onclick="sortTable(0)" style="cursor:pointer; text-align:center; width:100px;"> Jenjang <span class="sort-icon">⇅</span></th>
