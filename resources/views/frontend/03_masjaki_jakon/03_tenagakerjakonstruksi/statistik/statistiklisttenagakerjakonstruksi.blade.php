					...
					<div class="sidebar">
                        ...
                        <div class="sidebar-widget-list-inner">
                                ...
                                <ul style="list-style: none; padding: 0; text-align: center;">
                                    <li><a href="/datajakon/datajenjang1"><i class="fa-solid fa-chart-pie"></i> Data Statistik Jenjang 1</a></li>
                                    <li><a href="/datajakon/statistikdatajenjang2"><i class="fa-solid fa-chart-pie"></i> Data Statistik Jenjang 2</a></li>
                                    <li><a href="/datajakon/datajenjang3"><i class="fa-solid fa-chart-pie"></i> Data Statistik Jenjang 3</a></li>
                                    <li><a href="/datajakon/datajenjang4"><i class="fa-solid fa-chart-pie"></i> Data Statistik Jenjang 4</a></li>
                                    <li><a href="/datajakon/datajenjang5"><i class="fa-solid fa-chart-pie"></i> Data Statistik Jenjang 5</a></li>
                                    <li><a href="/datajakon/datajenjang6"><i class="fa-solid fa-chart-pie"></i> Data Statistik Jenjang 6</a></li>
                                    <li><a href="/datajakon/datajenjang7"><i class="fa-solid fa-chart-pie"></i> Data Statistik Jenjang 7</a></li>
                                    <li><a href="/datajakon/datajenjang8"><i class="fa-solid fa-chart-pie"></i> Data Statistik Jenjang 8</a></li>
                                    <li><a href="/datajakon/datajenjang9"><i class="fa-solid fa-chart-pie"></i> Data Statistik Jenjang 9</a></li>
                                    </ul>
