                        ...
                        <table class="fl-table">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:center"> Nama Tenaga Kerja</th>
                                    <th style="text-align:center"> Lokasi Kecelakaan</th>
                                    <th style="text-align:center"> Waktu </th>
                                    <th style="text-align:center"> Keterangan</th>
                                    <th style="text-align:center"> Nilai Kerugian</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($item->waktukecelakaan)->isoFormat('D MMMM YYYY') }}</td>
