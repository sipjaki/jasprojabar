                                ...
                                <table class="fl-table" id="sortableTable" style="margin-top: 15px; width: 100%; border-collapse: collapse;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th onclick="sortTable(1)" style="cursor:pointer; text-align:center; width:300px;"> Penyelenggara <span class="sort-icon">⇅</span></th>
                                            <th onclick="sortTable(2)" style="cursor:pointer; text-align:center; width:400px;"> Nama Badan Usaha<span class="sort-icon">⇅</span></th>
                                            <th onclick="sortTable(3)" style="cursor:pointer; text-align:center; width:150px;"> PJBU <span class="sort-icon">⇅</span></th>
