                                ...
                                <table class="fl-table" id="sortableTable" style="margin-top: 15px; width: 100%; border-collapse: collapse;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th onclick="sortTable(3)" style="cursor:pointer; text-align:center"> PJBU <span class="sort-icon">⇅</span></th>
                                    ...
                                    <tbody id="tableBody">
                                        ...
                                        <tr>
                                            ...
                                            <td class="namalengkap">{{$item->penyediastatustertibjakon->penyedia}}</td>
