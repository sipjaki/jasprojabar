				...
				<div class="col-12 col-lg-4 col-xl-4">
					<div class="sidebar">
						<div class="sidebar-widget-list-inner">
							<ul>
								<li><a href="/peraturan/undangundang"><i class="fa-solid fa-arrow-left-long"></i>Kembali</a></li>
								<li><a href="services.html">Peraturan Pemerintah<i class="fa-solid fa-arrow-right-long"></i></a></li>
								<li><a href="services.html">Peraturan Presiden<i class="fa-solid fa-arrow-right-long"></i></a></li>
								<li><a href="services.html">Peraturan Menteri<i class="fa-solid fa-arrow-right-long"></i></a></li>
								<li><a href="services.html">Keputusan Menteri<i class="fa-solid fa-arrow-right-long"></i></a></li>
								<li><a href="services.html">Surat Edaran Menteri<i class="fa-solid fa-arrow-right-long"></i></a></li>
								<li><a href="services.html">Referensi<i class="fa-solid fa-arrow-right-long"></i></a></li>
								<li><a href="services.html">Peraturan Daerah<i class="fa-solid fa-arrow-right-long"></i></a></li>
								<li><a href="services.html">Peraturan Gubernur<i class="fa-solid fa-arrow-right-long"></i></a></li>
								<li><a href="services.html">Peraturan Walikota/Bupati<i class="fa-solid fa-arrow-right-long"></i></a></li>
								<li><a href="services.html">Surat Keputusan<i class="fa-solid fa-arrow-right-long"></i></a></li>
