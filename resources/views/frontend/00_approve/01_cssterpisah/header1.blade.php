		...
		<div class="topbar-inner" style="background: #2ECC71 " >
			<div class="topbar-left" style="background: #2ECC71 ">
				<div class="topbar-socials">
                    ...
                    <a href="#"><i class="fa-brands fa-instagram" style="font-size: 25px; margin-top:20px;"></i></a>
                    {{-- <a href="#"><i class="fa-brands fa-whatsapp" style="font-size: 18px;"></i></a> --}}
                    <a href="#"><i class="fa-brands fa-facebook" style="font-size: 25px; margin-top:20px;"></i></a>
				</div><!--topbar-socials-->
        ...
        <div style="display: flex; align-items: center; margin-left: 100px;">
            ...
            <h1 style="margin-left: 10px; display: flex; flex-direction: column;">
               <h1 style="margin-left: 5px;">
                <span style="color: white; font-style:italic;">MASJAKI</span> <h1 style="color: green; font-style:italic;">BLORA</h1>
