...
<header class="header">
		...
		<div class="topbar-inner" style="background: #2ECC71 " >
			<div class="topbar-left" style="background: #2ECC71 ">
				<div class="topbar-socials" style="height: 8vh;">
                    ...
                    <a href="#"><i class="fa-brands fa-instagram" style="font-size: 28px; margin-top:15px;"></i></a>
                    <a href="#"><i class="fa-brands fa-whatsapp" style="font-size: 28px; margin-top:15px;"></i></a>
                    <a href="#"><i class="fa-brands fa-facebook" style="font-size: 28px; margin-top:15px;"></i></a>
				</div><!--topbar-socials-->
	...
	<div class="main-menu sticky-header" style="background: #1d1d1b" style="margin-bottom:10px;">
