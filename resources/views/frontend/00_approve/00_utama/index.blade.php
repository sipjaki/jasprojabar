...
<div class="page-wrapper">
			...
			<div class="department-section-inner">
				<div class="row row-gutter-y-40">
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-6">
                        <div class="department-card">
                            ...
                            <div class="department-card-content">
                                <h5><a href="https://dpupr.blorakab.go.id">DPUPR Kab Blora</a></h5>
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-6">
                        <div class="department-card">
                            <div class="department-card-icon">
                                <a href="/404"><i class="fas fa-graduation-cap"></i></a>
                            </div><!-- department-card-icon -->
                            <div class="department-card-content">
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-6">
                        <div class="department-card">
                            <div class="department-card-icon">
                                <a href="/404"><i class="fas fa-users"></i></a>
                            </div><!-- department-card-icon -->
                            <div class="department-card-content">
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-6">
                        <div class="department-card">
                            <div class="department-card-icon">
                                <a href="/404"><i class="fas fa-certificate"></i></a>
                            </div><!-- department-card-icon -->
                            <div class="department-card-content">
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-6">
                        <div class="department-card">
                            <div class="department-card-icon">
                                <a href="/404"><i class="fas fa-tools"></i></a>
                            </div><!-- department-card-icon -->
                            <div class="department-card-content">
    ...
    <section class="portfolio-section" style="margin-top: -200px;">
					...
					<div class="funfact-counter-item">
						<div class="funfact-counter-box">
							...
							<div class="funfact-counter-number">
								<h3 class="counter-number">234</h3>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="mayor-img">
						...
						<img src="/assets/00_dokmasjaki/01_berita/arifhidayat.jpg" alt="img-8" width="30">
