...
<body>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="tg-header__top-info">
                            <ul class="list-wrap">
                                <li><i class="flaticon-placeholder"></i>256 Avenue, Mark Street, NewYork City</li>
    ...
    <form action="{{ route('logout') }}" method="POST" style="display: inline;">
        @csrf
        <button type="submit" class="tg-btn tg-btn-four tg-btn-five" style="border: none; background: none; padding: 0; cursor: pointer;">
            Get a Quote
            <img src="assets/img/icons/right_arrow02.svg" alt="" class="injectable">
                                        ...
                                        <li class="offCanvas-menu">
                                            <a href="javascript:void(0)" class="menu-tigger">
                                                <img src="assets/img/icons/burger.svg" alt="" class="injectable">
                                        </a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="footer__widget">
                            ...
                            <div class="footer__contact">
                                <ul class="list-wrap">
                                    ...
                                    <li><i class="flaticon-envelope"></i><a href="mailto:info@beeko.com">info@beeko.com</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
