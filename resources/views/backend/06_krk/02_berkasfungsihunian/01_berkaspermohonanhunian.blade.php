...
<br>
    ...
    <h5 style="color: navy; font-weight:800; font-size:16px;">II. KELENGKAPAN BERKAS PERSYARATAN PERMOHONAN KRK FUNGSI USAHA</h4>
    {{-- <h5>KEPALA DINAS</h5> --}}
    <div class="table-responsive">
...
<form action="{{ route('validasikrkhunian', $data->id) }}" method="POST">
    @csrf
    @method('PUT')
                    <!-- /.card-header -->
...
@endcanany
                                    ...
                                    {{-- <tr>
                                        <th style="width: 400px; text-align:left; font-size: 16px; background-color: #e2e8f0; color: black;">
    <i class="bi bi-briefcase-fill"></i> Lampiran OSS
</th>
                                                    ...
                                                    <div class="modal-dialog modal-xl modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <img src="/assets/abgblora/logo/logokabupatenblora.png" width="25" class="me-2">
                                                                <img src="/assets/icon/pupr.png" width="25" class="me-2">
                                                                <h5 class="modal-title" id="modalLampiranossLbl{{ $data->id }}">lampiran OSS .pdf</h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                                            </div>
                                                            <div class="modal-body text-center">
                                                                <div style="margin-top: 10px;">
