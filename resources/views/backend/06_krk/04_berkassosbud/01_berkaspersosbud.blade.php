...
<hr>
    ...
    <h5 style="color: navy; font-weight:800; font-size:16px;">I. INFORMASI PERMOHONAN KETERANGAN RENCANA KOTA (KRK) FUNGSI SOSIAL BUDAYA</h4>
...
<br>
    ...
    <h5 style="color: navy; font-weight:800; font-size:16px;">II. KELENGKAPAN BERKAS PERSYARATAN PERMOHONAN KRK FUNGSI SOSIAL BUDAYA</h4>
    {{-- <h5>KEPALA DINAS</h5> --}}
    <div class="table-responsive">
