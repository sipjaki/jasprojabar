...
<div style="display: flex; justify-content: flex-end; gap: 10px;">
    ...
    @canany(['superadmin', 'admin'])
    <a href="/krkagamanoterbit/{{ $data->id }}" class="button-lolos"
    ...
    br {
        ...
        padding: 0 !important;
                ...
                <div>
                    ...
                    <h5 class="document-title">PERMOHONAN KETERANGAN RENCANA KOTA (KRK) FUNGSI KEAGAMAAN</h5>
                </div>
                <br>
            </div>
...
<script>
    function downloadPDF() {
        ...
        const opt = {
            ...
            filename: 'KRK_Fungsi_Keagamaan.pdf',
