...
<hr>
    ...
    <h5 style="color: navy; font-weight:800; font-size:16px;">I. INFORMASI PERMOHONAN KETERANGAN RENCANA KOTA (KRK) FUNGSI KEAGAMAAN</h4>
...
<tr>
    ...
    <td style="text-align: left;"><i class="bi bi-card-text" style="margin-right:6px;"></i> NIK</td>
    <td style="text-align: center;">:</td>
...
<tr>
    ...
    <td style="text-align: center;">:</td>
    <td style="text-align: left;">{{ $data->notelepon ?? '-' }}</td>
</tr>
<tr>
    <td style="text-align: center;">7</td>
    <td style="text-align: left;"><i class="bi bi-geo-alt" style="margin-right:6px;"></i> Koordinat Lokasi</td>
    <td style="text-align: center;">:</td>
    <td style="text-align: left;">{{ $data->koordinatlokasi ?? '-' }}</td>
</tr>
<tr>
    <td style="text-align: center;">8</td>
    <td style="text-align: left;"><i class="bi bi-pin-map" style="margin-right:6px;"></i> Kecamatan</td>
    <td style="text-align: center;">:</td>
    <td style="text-align: left;">{{ $data->kecamatanblora->kecamatanblora ?? '-' }}</td>
</tr>
<tr>
    <td style="text-align: center;">9</td>
    <td style="text-align: left;"><i class="bi bi-geo" style="margin-right:6px;"></i> Kelurahan/Desa</td>
    <td style="text-align: center;">:</td>
    <td style="text-align: left;">{{ $data->kelurahandesa->desa ?? '-' }}</td>
</tr>
<tr>
    <td style="text-align: center;">10</td>
    <td style="text-align: left;"><i class="bi bi-aspect-ratio" style="margin-right:6px;"></i> Luas Tanah</td>
    <td style="text-align: center;">:</td>
    <td style="text-align: left;">{{ $data->luastanah ? number_format($data->luastanah, 0, ',', '.') . ' m²' : '-' }}</td>
</tr>
<tr>
...
<tr>
    ...
    <td style="text-align: left;"><i class="bi bi-geo-fill" style="margin-right:6px;"></i> RT / RW</td>
    <td style="text-align: center;">:</td>
    <td style="text-align: left;">{{ $data->rt ?? '-' }}/{{ $data->rw ?? '-' }}</td>
</tr>
<tr>
...
<br>
    ...
    <h5 style="color: navy; font-weight:800; font-size:16px;">II. KELENGKAPAN BERKAS PERSYARATAN PERMOHONAN KRK FUNGSI KEAGAMAAN </h4>
    {{-- <h5>KEPALA DINAS</h5> --}}
    <div class="table-responsive">
...
<td style="text-align: center; font-size:16px;">
    ...
    @endif
            ...
            <td style="text-align: center;">
                    <div style="margin-top: 10px;">
    @if($data->npwp && file_exists(public_path('storage/' . $data->npwp)))
        <!-- Display the default iframe when the file exists in the storage -->
        <iframe
            src="{{ asset('storage/' . $data->npwp) }}"
            frameborder="0"
            width="100%"
            height="600px"
            style="transform: scale(0.8); transform-origin: top left; width: 125%; height: 500px;">
    ...
    @if($data->sertifikattanah && file_exists(public_path('storage/' . $data->sertifikattanah)))
        <!-- Display the default iframe when the file exists in the storage -->
        <iframe
            src="{{ asset('storage/' . $data->sertifikattanah) }}"
            frameborder="0"
            width="100%"
            height="600px"
            style="transform: scale(0.8); transform-origin: top left; width: 125%; height: 500px;">
    ...
    @elseif($data->sertifikattanah)
        <!-- Display the iframe with the updated file -->
        <iframe
            src="{{ asset($data->sertifikattanah) }}"
            frameborder="0"
            width="100%"
            height="600px"
            style="transform: scale(0.8); transform-origin: top left; width: 125%; height: 500px;">
...
<form action="{{ route('validasikrkkeagamaan', $data->id) }}" method="POST">
    @csrf
    @method('PUT')
                    <!-- /.card-header -->
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <img src="/assets/abgblora/logo/logokabupatenblora.png" width="25" class="me-2">
                                                            <img src="/assets/icon/pupr.png" width="25" class="me-2">
                                                            <h5 class="modal-title" id="modalFotoLbl{{ $data->id }}">NPWP Pemohon </h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                                        </div>
<div class="modal-body text-left">
    @if ($data->npwp)
