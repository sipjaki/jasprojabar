...
<div class="container">
    <div class="card">
        <div class="card-body p-4">
            <form action="{{ route('permohonan.perpengesahanagamacreate', ['id' => $data->id]) }}" method="POST">
                @csrf
                ...
                <input type="hidden" name="krkkeagamaan_id" value="{{ $krkkeagamaan_id ?? '' }}">
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        const nomorRegistrasi = `${idData}/FKA/BG/KRK/${month}/${year}`;
