...
<br>
        ...
        {{-- ======================================================= --}}
                    <div class="col-md-12">
                        <!--begin::Quick Example-->
                  <form action="{{ route('bekrkkeagamaanperbaikannewupdate', $data->id) }}" method="POST" enctype="multipart/form-data">
          @csrf
                            <!-- begin::Body -->
                            <div class="card-body">
                                <div class="row">
...
<div class="text-center">
    ...
    <h5 style="color: #0d6efd; font-weight: bold; margin-top: 5px; font-size:16px;">
        ...
        Upload Perbaikan Berkas Keterangan Rencana Kota (KRK) Fungsi Keagamaan
    </h5>
    <hr class="my-4" style="border-top: 2px dashed #0d6efd; width: 60%; margin: auto;">
</div>
