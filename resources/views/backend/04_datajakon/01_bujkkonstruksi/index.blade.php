                    ...
                    ⚙️ Setting Database
                     ...
                     <div style="display: flex; justify-content: flex-end; margin-bottom: 5px;">
                         <a href="/404">
                             ...
                             style="background-color: white; color: black; border: none; margin-right: 10px; padding: 10px 20px; border-radius: 15px; font-size: 16px; cursor: pointer; display: flex; align-items: center; transition: background-color 0.3s, color 0.3s; text-decoration: none;">
                             <!-- Ikon Kembali -->
...
<table class="table table-striped">
 <thead>
     <tr>
         ...
         <th style="width: 200px; text-align:center; background:#1E40AF; color:white;">Asosiasi</th>
     ...
     <tr class="align-middle">
         ...
         <td style="text-align: left;">{{$item->no_pengesahan}}</td>
             ...
             <td style="text-align: center; vertical-align: middle; width: 100%; align-items:center;">
                <a href="{{ url('/bebujkkonstruksi/showsubklasifikasi/' . $item->bujkkontraktorsub?->id) }}" style="text-decoration: none;">
                <button
                    onmouseover="this.style.backgroundColor='white'; this.style.color='black';"
