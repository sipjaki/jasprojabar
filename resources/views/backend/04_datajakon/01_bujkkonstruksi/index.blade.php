                 ...
                 <div class="card-header">
                     ...
                     <div style="display: flex; justify-content: flex-end; margin-bottom: 5px;">
                         <a href="/bebujkjakon">
                             ...
                             style="background-color: #ffd100; color: white; border: none; margin-right: 10px; padding: 10px 20px; border-radius: 15px; font-size: 16px; cursor: pointer; display: flex; align-items: center; transition: background-color 0.3s, color 0.3s; text-decoration: none;">
                             <!-- Ikon Kembali -->
