...
<div class="card-header">
    ...
    <div style="display: flex; justify-content: flex-end; margin-bottom:10px;">
        <button class="button-kembali"
                type="button"
                onclick="location.href='{{ route('bebantekdinaskerusakanindex') }}';"
...
@canany(['superadmin', 'admin'])
 <div style="display: flex; justify-content: flex-end; margin-bottom:5px;">
        <button class="button-kembali"
                type="button"
                onclick="location.href='{{ route('beperhitungankerusakanindex') }}';"
                style="cursor: pointer; color:black;">
            <i class="bi bi-arrow-left" style="margin-right: 5px;"></i> Kembali
        </button>
    </div>
...
<td style="text-align: center; font-size:16px;">
    ...
    <table class="zebra-table table-striped">
        <tr>
          ...
          <td style="text-align: center; font-size:16px;">
    <i class="bi bi-file-earmark-text" style="margin-right:6px; color: navy;"></i> Rencana Anggaran Biaya
</td>
<td style="text-align: center; font-size:16px;">
    <i class="bi bi-file-earmark-richtext" style="margin-right:6px; color: navy;"></i> As Built Draw
</td>
...
<td style="text-align: center;">
    <div style="margin-top: 10px;">
        @php
            $filePath = public_path('storage/' . $data->rab);
        @endphp

        @if($data->rab && file_exists($filePath))
            <!-- Jika file ada di direktori storage -->
            <iframe
                src="{{ asset('storage/' . $data->rab) }}"
                frameborder="0"
                style="transform: scale(0.8); transform-origin: top left; width: 125%; height: 500px;">
            </iframe>
        @elseif($data->rab)
...
<td style="text-align: center;">
    <div style="margin-top: 10px;">
        @php
            $filePath = public_path('storage/' . $data->asbuilt);
        @endphp

        @if($data->asbuilt && file_exists($filePath))
            <!-- Jika file ada di direktori storage -->
            <iframe
                src="{{ asset('storage/' . $data->asbuilt) }}"
                frameborder="0"
                style="transform: scale(0.8); transform-origin: top left; width: 125%; height: 500px;">
            </iframe>
        @elseif($data->asbuilt)
    ...
    <div style="display: flex; align-items: center; gap: 15px;">
        <p style="margin: 0;">
            Silahkan Lakukan Perbaikan Data <i class="bi bi-arrow-right"></i>
                ...
                <a href="/beperhitungankerusakanper/{{$data->id}}" style="text-decoration: none;">
...
<form action="{{ route('validasidokumenbantek4', $data->id) }}" method="POST">
    @csrf
    @method('PUT')
                    <!-- /.card-header -->
...
<div style="display: flex; justify-content: center;">
    <button type="button" class="button-kembali"
        ...
        onmouseover="this.style.backgroundColor='#ffffff'; this.style.color='#6c757d'; this.style.border='1px solid #6c757d'; this.style.boxShadow='0 6px 10px rgba(0, 0, 0, 0.25)'; this.style.transform='translateY(-2px)'"
        onmouseout="this.style.backgroundColor='#6c757d'; this.style.color='white'; this.style.border='none'; this.style.boxShadow='0 4px 6px rgba(0, 0, 0, 0.2)'; this.style.transform='translateY(0)'"
        data-bs-toggle="modal" data-bs-target="#modalRab{{ $data->id }}">
        <i class="bi bi-eye" style="margin-right: 6px;"></i> Lihat
    </button>
</div>

                                            <!-- Modal KTP -->
                                            <div class="modal fade" id="modalRab{{ $data->id }}" tabindex="-1" aria-labelledby="modalRabLbl{{ $data->id }}" aria-hidden="true">
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <img src="/assets/abgblora/logo/logokabupatenblora.png" width="25" class="me-2">
                                                            <img src="/assets/icon/pupr.png" width="25" class="me-2">
                                                            <h5 class="modal-title" id="modalRabLbl{{ $data->id }}">Anggaran Rencana Biaya</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                                        </div>
...
<div class="modal-body text-left">
    @if ($data->rab)
        @php
            $filePath = public_path($data->rab);
            $fileUrl = asset($data->rab);
            $extension = strtolower(pathinfo($data->rab, PATHINFO_EXTENSION));
        @endphp
        ...
        @if (file_exists($filePath))
            ...
            @endif
            <div class="text-center">
                <a href="{{ $fileUrl }}" class="btn btn-primary mt-2" download>Download RAB</a>
            </div>
        @else
            <p style="color: red; font-weight: bold;">File tidak ditemukan !.</p>
        @endif
    @else
        <p style="color: red; font-weight: bold;">Data belum diupdate.</p>
    @endif
...
@canany(['superadmin', 'admin'])
    <th class="text-center" style="background-color: #e2e8f0; color: black;">
        <div style="display: flex; justify-content: center; gap: 20px;">
            <label class="custom-radio">
                <input type="radio" name="validasirab" value="sesuai"
                    {{ $data->validasirab == 'sesuai' ? 'checked' : '' }}>
                <span class="custom-box"></span>
                Sesuai
            </label>

            <label class="custom-radio">
                <input type="radio" name="validasirab" value="tidak_sesuai"
                    {{ $data->validasirab == 'tidak_sesuai' ? 'checked' : '' }}>
                <span class="custom-box"></span>
                Tidak Sesuai
            </label>
        </div>
...
@endcanany
  ...
  <tr>
                                        {{-- <th style="width: 25px; text-align:center;"><i class="bi bi-hash"></i> No</th> --}}
                                        <th style="width: 400px; text-align:left; font-size: 16px; background-color: #e2e8f0; color: black;"><i class="bi bi-file-earmark-text-fill"></i> As Built Drawing </th>
                                        <th class="text-center" style="background-color: #e2e8f0; color: black;">
<div style="display: flex; justify-content: center;">
    <button type="button" class="button-kembali"
        style="
        ...
        onmouseover="this.style.backgroundColor='#ffffff'; this.style.color='#6c757d'; this.style.border='1px solid #6c757d'; this.style.boxShadow='0 6px 10px rgba(0, 0, 0, 0.25)'; this.style.transform='translateY(-2px)'"
        onmouseout="this.style.backgroundColor='#6c757d'; this.style.color='white'; this.style.border='none'; this.style.boxShadow='0 4px 6px rgba(0, 0, 0, 0.2)'; this.style.transform='translateY(0)'"
        data-bs-toggle="modal" data-bs-target="#modalAsbuiltdraw{{ $data->id }}">
        <i class="bi bi-eye" style="margin-right: 6px;"></i> Lihat
    </button>
</div>

                                            <!-- Modal KTP -->
                                            <div class="modal fade" id="modalAsbuiltdraw{{ $data->id }}" tabindex="-1" aria-labelledby="modalAsbuiltdrawLbl{{ $data->id }}" aria-hidden="true">
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <img src="/assets/abgblora/logo/logokabupatenblora.png" width="25" class="me-2">
                                                            <img src="/assets/icon/pupr.png" width="25" class="me-2">
                                                            <h5 class="modal-title" id="modalAsbuiltdrawLbl{{ $data->id }}">As Built Drawing</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                                        </div>
...
<div class="modal-body text-left">
    @if ($data->asbuilt)
        @php
            $filePath = public_path($data->asbuilt);
            $fileUrl = asset($data->asbuilt);
            $extension = strtolower(pathinfo($data->asbuilt, PATHINFO_EXTENSION));
        @endphp
        ...
        @if (file_exists($filePath))
            ...
            @endif
            <div class="text-center">
                <a href="{{ $fileUrl }}" class="btn btn-primary mt-2" download>Download As Built Drawing</a>
            </div>
        @else
            <p style="color: red; font-weight: bold;">File tidak ditemukan !.</p>
        @endif
...
@canany(['superadmin', 'admin'])
    <th class="text-center" style="background-color: #e2e8f0; color: black;">
        <div style="display: flex; justify-content: center; gap: 20px;">
            <label class="custom-radio">
                <input type="radio" name="validasiasbuilt" value="sesuai"
                    {{ $data->validasiasbuilt == 'sesuai' ? 'checked' : '' }}>
                <span class="custom-box"></span>
                Sesuai
            </label>

            <label class="custom-radio">
                <input type="radio" name="validasiasbuilt" value="tidak_sesuai"
                    {{ $data->validasiasbuilt == 'tidak_sesuai' ? 'checked' : '' }}>
                <span class="custom-box"></span>
                Tidak Sesuai
            </label>
        </div>
