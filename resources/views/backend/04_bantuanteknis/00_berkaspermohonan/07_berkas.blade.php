...
<div class="card-header">
    ...
    <div style="display: flex; justify-content: flex-end; margin-bottom:10px;">
        <button class="button-kembali"
                type="button"
                onclick="location.href='{{ route('bebantekdinasserahterimaindex') }}';"
...
@canany(['superadmin', 'admin'])
 <div style="display: flex; justify-content: flex-end; margin-bottom:5px;">
        <button class="button-kembali"
                type="button"
                onclick="location.href='{{ route('beserahterimaindex') }}';"
                style="cursor: pointer; color:black;">
            <i class="bi bi-arrow-left" style="margin-right: 5px;"></i> Kembali
        </button>
    </div>
    ...
    <div style="display: flex; align-items: center; gap: 15px;">
        <p style="margin: 0;">
            Silahkan Lakukan Perbaikan Data <i class="bi bi-arrow-right"></i>
                ...
                <a href="/beserahterimaper/{{$data->id}}" style="text-decoration: none;">
...
<form action="{{ route('validasidokumenbantek7', $data->id) }}" method="POST">
    @csrf
    @method('PUT')
                    <!-- /.card-header -->
