...
<a href="{{ url('/bepersontimteknis') }}" class="button-kembali" style="cursor: pointer; margin-left:10px; color:black; display: inline-flex; align-items: center; text-decoration: none;">
...
<br>
        ...
        {{-- ======================================================= --}}
                    <div class="col-md-12">
                        <!--begin::Quick Example-->
                        <form action="{{ route('create.bebanteklapper8create') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <!-- begin::Body -->
                            <div class="card-body">
                                <div class="row">
