        ...
        <script>
                ...
                window.location.href = url.toString();
                        ...
                        <script>
                            ...
                            fetch(`/beperhitunganpenyusutan?search=${input}`)
...
<script>
    function openModal(itemId) {
        ...
        form.action = `/validasiberkas3permohonan1/${itemId}`;
...
<script>
    function openModal2(itemId) {
        ...
        form.action = `/validasiberkas3permohonan2/${itemId}`;
...
<script>
    function openModal3(itemId) {
        ...
        form.action = `/validasiberkas3permohonan3/${itemId}`;
...
<script>
    function openModal4(itemId) {
        ...
        form.action = `/validasiberkas3permohonan4/${itemId}`;
