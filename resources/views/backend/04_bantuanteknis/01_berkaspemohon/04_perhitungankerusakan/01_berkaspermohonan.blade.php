        ...
        <script>
                ...
                window.location.href = url.toString();
                        ...
                        <script>
                            ...
                            fetch(`/beperhitungankerusakan?search=${input}`)
...
<script>
    function openModal(itemId) {
        ...
        form.action = `/validasiberkas4permohonan1/${itemId}`;
...
<script>
    function openModal2(itemId) {
        ...
        form.action = `/validasiberkas4permohonan2/${itemId}`;
...
<script>
    function openModal3(itemId) {
        ...
        form.action = `/validasiberkas4permohonan3/${itemId}`;
...
<script>
    function openModal4(itemId) {
        ...
        form.action = `/validasiberkas4permohonan4/${itemId}`;
