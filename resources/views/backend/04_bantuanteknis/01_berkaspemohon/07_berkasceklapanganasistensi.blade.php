...
<br>
     ...
     <div class="container-fluid">
         <!--begin::Row-->
         <div class="buton-belakang row" style="margin-right: 10px; margin-left:10px;">
             <!-- /.card -->
             <div class="card mb-4">
...
<a href="{{ url('/bebantuanteknisassistensi') }}" class="button-validasinew" style="cursor: pointer; color:black; margin-left:5px; display: inline-flex; align-items: center; text-decoration: none;">
    <i class="bi bi-arrow-left" style="margin-right: 5px;"></i> Kembali
</a>
        @endcanany
...
function setDeleteUrl(button) {
    ...
    var deleteUrl = "/bebantuanteknislapangandelete/" + encodeURIComponent(id);
