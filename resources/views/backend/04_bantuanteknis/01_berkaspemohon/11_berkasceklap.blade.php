...
@endcan
                        ...
                        onclick="location.href='{{ url('/bebantekdinaskerusakan') }}';"
                        style="cursor: pointer; color:black; margin-left:5px;">
                        <i class="bi bi-arrow-left" style="margin-right: 5px;"></i> Kembali
                        </button>
                    @endcan
...
<button class="button-create" type="button"
    onclick="location.href='/bebanteklapper4create/{{ $data->id }}';"
    style="cursor: pointer; margin-left:10px; color:black;">
    <i class="bi bi-file-earmark-plus" style="margin-right: 5px;"></i> Buat Dokumentasi
</button>

<a href="{{ url('/beperhitungankerusakan') }}" class="button-kembali" style="cursor: pointer; color:black; margin-left:5px; display: inline-flex; align-items: center; text-decoration: none;">
    <i class="bi bi-arrow-left" style="margin-right: 5px;"></i> Kembali
</a>
...
function setDeleteUrl(button) {
    ...
    var deleteUrl = "/bebanteklapper4delete/" + encodeURIComponent(id);
