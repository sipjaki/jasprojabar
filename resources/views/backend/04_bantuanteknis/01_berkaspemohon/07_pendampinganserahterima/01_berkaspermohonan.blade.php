        ...
        <script>
                ...
                window.location.href = url.toString();
                        ...
                        <script>
                            ...
                            fetch(`/beserahterima?search=${input}`)
...
{{-- @endcanany --}}
        ...
        <th style="background-color: #ADD8E6;"><i class="fas fa-map-marked-alt"></i> Lokasi Bangunan</th>
            ...
            <td style="text-align: center;">
                <a href="{{ route('beserahterima.show', $item->id) }}"
...
<script>
    function openModal(itemId) {
        ...
        form.action = `/validasiberkas7permohonan1/${itemId}`;
  ...
  <td style="text-align: center;">
                <a href="{{ route('bebanteklapper7.show', $item->id) }}"
                    class="button-kembali"
                    style="border-radius: 15px; padding: 8px 16px; background-color: #6c757d; color: black; border: none; transition: background-color 0.3s, color 0.3s;"
                    onmouseover="this.style.backgroundColor='#ffffff'; this.style.color='#6c757d'; this.style.border='1px solid #6c757d';"
                    onmouseout="this.style.backgroundColor='#6c757d'; this.style.color='white'; this.style.border='none';">
...
<script>
    function openModal2(itemId) {
        ...
        form.action = `/validasiberkas7permohonan2/${itemId}`;
...
<script>
    function openModal3(itemId) {
        ...
        form.action = `/validasiberkas7permohonan3/${itemId}`;
...
<script>
    function openModal4(itemId) {
        ...
        form.action = `/validasiberkas7permohonan4/${itemId}`;
  ...
  <td style="text-align: center;">
                <a href="{{ route('bebantek7.uploadberkasnew7', $item->id) }}"
                    class="button-kembali"
                    style="border-radius: 15px; padding: 8px 16px; background-color: #6c757d; color: black; border: none; transition: background-color 0.3s, color 0.3s;"
                    onmouseover="this.style.backgroundColor='#ffffff'; this.style.color='#6c757d'; this.style.border='1px solid #6c757d';"
                    onmouseout="this.style.backgroundColor='#6c757d'; this.style.color='white'; this.style.border='none';">
