...
<div class="page-heading">
    <h4>Selamat Datang ! {{ auth()->user()->username }} di Sistem Informasi Pembina Jasa Konstruksi Kabupaten Blora Anda Adalah  <button style="background-color: #009116; color: white; padding: 10px 20px; border: none; border-radius: 10px; cursor: pointer; font-size: 16px;"
