  ...
  <div class="card bg-transparent shadow-none my-6 border-0">
    <div class="card-body row p-0 pb-6 g-6">
      <div class="col-12 col-lg-8 card-separator">
        ...
        <h5 class="mb-2">Selamat Datang ! <span class="h4"> {{ Auth::user()->username }} 👋🏻 </span></h5><h4>di Sistem Informasi Pembina Jasa Konstruksi Mas Jaki Blora Kabupaten Blora</h4>
