...
<footer class="content-footer footer bg-footer-theme">
    <div class="container-xxl">
      <div class="footer-container d-flex align-items-center justify-content-between py-4 flex-md-row flex-column">
        <div class="mb-2 mb-md-0">
          ...
          </script>, Dinas Pekerjaan Umum Dan Penataan Ruang Kabupaten Blora Provinsi Jawa Tengah  Designed by ❤️ <a href="https://wa.me/6281321455855" target="_blank" class="footer-link">CV. Angkasa Raya Teknik</a>
        </div>
  ...
  <!-- / Layout wrapper -->
        ...
        <div class="buy-now">
          <a href="https://themeselection.com/item/sneat-dashboard-pro-bootstrap/" target="_blank" class="btn btn-danger btn-buy-now">Contact Me</a>
        </div>
