        ...
        <script>
                ...
                window.location.href = url.toString();
                        ...
                        <div style="position: relative; display: inline-block; margin-right:10px;">
                            <input type="search" id="searchInput" placeholder="Cari Jalan ...." onkeyup="searchTable()" style="border: 1px solid #ccc; padding: 10px 20px; font-size: 14px; border-radius: 10px; width: 300px;">
                        ...
                        <script>
                            ...
                            fetch(`/datagsbblora?search=${input}`)
...
<th style="background-color: #ADD8E6;"><i class="bi bi-signpost-split"></i> Ruas Jalan</th>
<th style="background-color: #ADD8E6;"><i class="bi bi-diagram-3"></i> Jenis Jalan</th>
            ...
            <td style="text-align: center; vertical-align: middle;">
                {{-- <a href="/404" class="btn btn-sm btn-info me-2" title="Show">
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/bedatagsbbloradelete/" + encodeURIComponent(id);
